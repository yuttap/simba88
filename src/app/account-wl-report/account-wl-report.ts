...
@Component({
    selector: '[account]',
    templateUrl: './account-wl-report.html',
    styleUrls: [ './account-wl-report.style.scss' ],
    encapsulation: ViewEncapsulation.None
})

export class AccountWlReport implements OnInit{
    ...
    onLoad(){
        let obj = {
            ...
            endDate: '2300-12-31T05:00:00.000Z',
