...
@Component({
    selector: 'manual-point',
    styleUrls: ['./manual-point.style.scss'],
    templateUrl: './manual-point.template.html',
    host: {
        class: 'report-hide-page app'
    }
})
export class ManualPoint implements OnInit {
    ...
    onLoad(){
        ...
        this.http.post(`${this.settings.getAppSetting('url')}/campaign/transactionProblemCampaign`, obj)
